...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/sentimony/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/sentimony/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
    ...
    copy: {
      css: {
        files: [
          ...
          { src: ['changelog.txt'], dest: 'dist/sentimony', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', function () {
    grunt.file.write('dist/sentimony/version.txt', BUILD_VERSION);
  });
