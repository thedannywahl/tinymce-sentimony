...
var _emotions = __webpack_require__(2);

var _emotions2 = _interopRequireDefault(_emotions);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Langs = function Langs(options) {
...
Langs.prototype.strings = {
  en: {
    ...
    labelSelectCategory: function labelSelectCategory() {
      return "Select a category";
    },
    labelOverview: function labelOverview() {
      return "Sentiment Overview";
    },
    labelDetail: function labelDetail() {
      return "Sentiment Details";
    },
    containerDetail: function containerDetail(data) {
      return "<pre id=\"sentimony-report-details\">" + JSON.stringify(data, null, 2) + "</pre>";
    },
    containerOverview: function containerOverview(data) {
      ...
      var strength = Langs.prototype.comparativeToScale(data, emotion);
...
Langs.prototype.t = function () {
  var l = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'en';
  var s = arguments[1];
  var d = arguments[2];
...
Langs.prototype.comparativeToScale = function (data, emotion) {
  ...
  var scale = data.score / data.words.length;
  if (scale < 0) scale = scale * -1;
  scale = Math.ceil(scale);
  scale = Object.keys(_emotions2.default[emotion])[scale];
  return _emotions2.default[emotion][scale];
};
...
module.exports = {
    labels: __webpack_require__(10),
    scoringStrategy: __webpack_require__(12)
};
...
module.exports = {"neutral":{"slightly":{"scale":"","name":"Face without Mouth","html":"&#x1F636;","emoji":"😶","expression":"neutral"},"somewhat":{"scale":"","name":"Face without Mouth","html":"&#x1F636;","emoji":"😶","expression":"neutral"},"moderately":{"scale":"","name":"Face without Mouth","html":"&#x1F636;","emoji":"😶","expression":"neutral"},"very":{"scale":"","name":"Face without Mouth","html":"&#x1F636;","emoji":"😶","expression":"neutral"},"extremely":{"scale":"","name":"Face without Mouth","html":"&#x1F636;","emoji":"😶","expression":"neutral"}},"joy":{"slightly":{"scale":"slightly","name":"Slightly Smiling Face","html":"&#x1f642;","emoji":"🙂","expression":"joyful"},"somewhat":{"scale":"somewhat","name":"Smiling Face with Smiling Eyes","html":"&#x1f60a;","emoji":"😊","expression":"joyful"},"moderately":{"scale":"moderately","name":"Grinning Face","html":"&#x1F600;","emoji":"😀","expression":"joyful"},"very":{"scale":"very","name":"Grinning Face with Big Eyes","html":"&#x1F603;","emoji":"😃","expression":"joyful"},"extremely":{"scale":"extremely","name":"Grinning Face with Smiling Eyes","html":"&#x1F601;","emoji":"😁","expression":"joyful"}},"sadness":{"slightly":{"scale":"slightly","name":"Slightly Frowning Face","html":"&#x1f641;","emoji":"🙁","expression":"sad"},"somewhat":{"scale":"somewhat","name":"Disappointed Face","html":"&#x1F61E","emoji":"😞","expression":"sad"},"moderately":{"scale":"moderately","name":"Frowning Face with Open Mouth","html":"&#x1f626;","emoji":"😦","expression":"sad"},"very":{"scale":"very","name":"Crying Face","html":"&#x1F622","emoji":"😢","expression":"sad"},"extremely":{"scale":"extremely","name":"Loudly Crying Face","html":"&#x1F62D;","emoji":"😭","expression":"sad"}},"anger":{"slightly":{"scale":"slightly","name":"Grimacing Face","html":"&#x1F62C;","emoji":"😬","expression":"angry"},"somewhat":{"scale":"somewhat","name":"Angry Face","html":"&#x1f620;","emoji":"😠","expression":"angry"},"moderately":{"scale":"moderately","name":"Pouting Face","html":"&#x1f621;","emoji":"😡","expression":"angry"},"very":{"scale":"very","name":"Face with Steam from Nose","html":"&#x1F624;","emoji":"😤","expression":"angry"},"extremely":{"scale":"extremely","name":"Serious Face with Symbols on Mouth","html":"&#x1F92C;","emoji":"🤬","expression":"angry"}},"fear":{"slightly":{"scale":"slightly","name":"Worried Face","html":"&#x1f61f;","emoji":"😟","expression":"fearful"},"somewhat":{"scale":"somewhat","name":"Anguished Face","html":"&#x1F627;","emoji":"😧","expression":"fearful"},"moderately":{"scale":"moderately","name":"Fearful Face","html":"&#x1F628;","emoji":"😨","expression":"fearful"},"very":{"scale":"very","name":"Anxious Face with Sweat","html":"&#x1f605;","emoji":"😰","expression":"fearful"},"extremely":{"scale":"extremely","name":"Face Screaming in Fear","html":"&#x1f631;","emoji":"😱","expression":"fearful"}}}
...
var _sentiment = __webpack_require__(13);
...
var _sentimony = __webpack_require__(5);

var _sentimony2 = _interopRequireDefault(_sentimony);

var _sentimony3 = __webpack_require__(0);

var _sentimony4 = _interopRequireDefault(_sentimony3);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var sentiment = new _sentiment2.default();

var sentimony = new _sentimony2.default();

var s = new _sentimony4.default();
var l = tinymce.util.I18n.getCode();
var globalData = {};
...
var plugin = function plugin(editor) {
        ...
        editor.windowManager.open({
          ...
          body: [{
            ...
            onselect: function onselect(e) {
              var selectedSection = this.$el[0].innerText;
              sentimony.showReport(selectedSection, globalData);
            },
            values: [{ text: s.t(l, "labelOverview"), value: s.t(l, "labelOverview"), selected: true }, { text: s.t(l, "labelDetail"), value: s.t(l, "labelDetail") }]
          }, {
            type: 'container',
  ...
  editor.on('Change', function (e) {
    sentiment.analyze(editor.getContent({ format: 'text' }), {}, function (i, data) {
      globalData = data;
      globalData.tokens = globalData.tokens.filter(function (n) {
        return n;
      });
...
tinymce.PluginManager.add('sentimony', _plugin2.default);
...
var _sentimony = __webpack_require__(0);

var _sentimony2 = _interopRequireDefault(_sentimony);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var s = new _sentimony2.default();
var l = tinymce.util.I18n.getCode();

var Sentimony = function Sentimony(options) {
  this.options = options;
};

Sentimony.prototype.setComparativeSentiment = function (data, emotions) {
  var emotion = document.getElementById("sentimony-emotion");
  if (data.comparative > 0) {
...
Sentimony.prototype.showReport = function (section, data) {
  var overview = s.t(l, "containerOverview", data);
  var detail = s.t(l, "containerDetail", data);

  var reportBody = document.getElementById("sentimony-report-body");
  var report = overview;
  if (reportBody) {
...
var negators = __webpack_require__(11);
...
/* WEBPACK VAR INJECTION */(function(process) {var tokenize = __webpack_require__(15);
var languageProcessor = __webpack_require__(14);
...
var emojis = __webpack_require__(8);

// English is loaded by default
var enLanguage = __webpack_require__(1);
// Add emojis
...
module.exports = {
    ...
    getLanguage: function(languageCode) {
        ...
        if (!languages[languageCode]) {
            ...
            try {
                // eslint-disable-next-line max-len
                var language = __webpack_require__(9)("./" + languageCode + '/index');
